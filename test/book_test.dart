...
void main() {
  ...
  group('Book', () {
    ...
    test('Book properties should be set correctly', () {
      final book = Book('Title', 'Author', 'Summary',
          DateTime(2023, 1, 1), color: Colors.red);
  ...
  group('BookUI', () {
    ...
    testWidgets('BookUI should display book title',
            (WidgetTester tester) async {
          final book = Book('Title', 'Author', 'Summary', DateTime(2023, 1, 1));

          await tester.pumpWidget(MaterialApp(
            home: Scaffold(
              body: BookUI(book, key:ValueKey<DateTime>(book.date),
                  onDelete: (Book book) {}),
            ),
          ));
    ...
    testWidgets('BookUI should call onDelete when delete button is pressed',
            (WidgetTester tester) async {
          final book = Book('Title', 'Author', 'Summary', DateTime(2023, 1, 1));
          bool deleted = false;
