...
void main() {
  group('Shelf', () {
    test('sorts books by title', () {
      ...
      shelf.addBook(Book('Harry Potter and the Order of the Phoenix',
          'J. K. Rowling', 'He said calmly', DateTime(2003, 6, 21)));
      shelf.addBook(Book('Game of Thrones', 'George RR Martin',
          'Bilbo Baggins', DateTime(1996, 8, 1)));
      shelf.addBook(Book('IDK anymore', 'J. K. Rowling',
          'IDK man this aint a book', DateTime.now()));
      shelf.addBook(Book('Random Book', 'J. K. Rowling',
      ...
      expect(shelf.books[1].title, equals('Harry Potter and the Order '
          'of the Phoenix'));
    ...
    test('sorts books by date', () {
      ...
      shelf.addBook(Book('Game of Thrones', 'George RR Martin',
          'Bilbo Baggins', DateTime(1996, 8, 1)));
      shelf.addBook(Book('IDK anymore', 'J. K. Rowling',
          'IDK man this aint a book', DateTime(2001, 2, 1)));
      shelf.addBook(Book('Random Book', 'J. K. Rowling',
          'probability of me being a book = 0', DateTime(2024,7,22)));
      ...
      expect(shelf.books[2].title,
          equals('Harry Potter and the Order of the Phoenix'));
      expect(shelf.books[3].title, equals('Random Book'));
    });
  });
}
